...
function ProjectItem({ image, name, text }) { // Defining a functional component named ProjectItem and destructuring props
   return (
     <div className="projectItem"> {/* Creating a div element with class name 'projectItem' */}
       ...
       <p> {text} </p> {/* Creating a p element with project description */}
     </div>
  );
 }
...
text: PropTypes.string.isRequired, // description prop is required and should be a string
};
